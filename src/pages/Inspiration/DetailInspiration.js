      ...
      return inspiration.product.map((p) => {
        return (
          <div className="col-md-3" key={`product-${p.productId}`}>
            <ProductCard thumbnail={p.thumbnail ? p.thumbnail : 'https://via.placeholder.com/600x600'} loved={this.isProductWishlisted(p.productId)} id={p.productId} title={p.productName} price={p.price} category={""} />
          </div >
        )
      })
    }
        ...
        <div>
          ...
          <div className="content">
            <section className="section-page">
              <div className="banner-inspiration"
                style={{ backgroundImage: `url(${inspiration.banner}` }} alt="" >
          ...
          <section className="section-page">
            <div className="container">
              <div className="row align-items-center mb--2">
                <h3 className="section-title mb--0">Inspirasi tidak ditemukan </h3>
              </div>
            </div>
          </section>
        </div>
